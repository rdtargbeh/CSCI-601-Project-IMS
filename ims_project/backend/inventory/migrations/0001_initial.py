    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('outgoing_stock', models.PositiveIntegerField(default=0)),
                ...
                ('warehouse', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='inventory_stock', to='inventory.warehouse')),
            ],
        ),
        migrations.CreateModel(
            name='Report',
